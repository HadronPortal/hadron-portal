                            ...
                            <DropdownMenu>
                              <DropdownMenuTrigger asChild>
                                <Button
                                  variant="outline"
                                  size="sm"
                                  className="h-8 px-4 text-xs font-medium gap-1.5 rounded-lg border border-border text-muted-foreground bg-card transition-all duration-150 hover:bg-primary/10 hover:text-primary hover:border-primary/40 data-[state=open]:bg-primary/10 data-[state=open]:text-primary data-[state=open]:border-primary/40"
                                >
                                  Ações
                                  <ChevronDown size={14} />
                                </Button>
